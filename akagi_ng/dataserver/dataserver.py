...
from akagi_ng.core.paths import get_frontend_dir
from akagi_ng.dataserver.api import cors_middleware, setup_routes, setup_static_routes
...
class DataServer(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            setup_routes(app)
            setup_static_routes(app, self.frontend_dist_dir)
