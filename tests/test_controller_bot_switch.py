...
def test_bot_switch_scenarios():
    ...
    with patch.dict(
        "sys.modules", {"akagi_ng.mjai_bot.mortal.bot": MagicMock(MortalBot=MockMortalBot, Mortal3pBot=MockMortal3pBot)}
    ):
        with patch("akagi_ng.mjai_bot.controller.local_settings") as mock_settings:
